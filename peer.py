...
class Blockchain:
    ...
    def add_block(self, block, proof):
        ...
        * The previous_hash referred in the block and the hash of latest block
          in the chain match.
        """
        #print("all attr  : "+str(dir(self.last_block)))
        previous_hash = self.last_block.hash
        #print("pre hash : "+previous_hash)
        #print("pre hash ghabli : "+self.last_block.hash)
        #print("now hash : "+block.previous_hash)
    ...
    def mine(self):
        ...
        #print("before add new block in mine func:" + str(new_block.transactions))
        res = self.add_block(new_block, proof)
        #print(res)
        #print("after add "+str(self.chain[-1].transactions))
        self.unconfirmed_transactions = []
...
def get_chain():
    ...
    #print("get chain   "+str(chain_data))
